...
contains a function call instruction and f ∈ F , we define OCF EC(G, e) as G potentially with
...
• Function Entry Identification: Given an edge e = (a → b) in a graph G, we define OF E I(G, e)
as G with the block b potentially labeled as a function entry. This operation is trivial if e was
...
• Edge Removal: Given an edge e = (a → b) within a graph G, we define OER(G, e) as G with
...
the intermediate results and Gn as the final CFG.*/
    ...
    */
    public class DivergingFunctionFinder
    {
        ...
        private bool ContainsRetBlock(object blocks)
        {
            throw new System.NotImplementedException();
        }

        private object ReachableBlocks(Address f, IEnumerable<Address> funcList)
        {
            throw new System.NotImplementedException();
        }
    }
